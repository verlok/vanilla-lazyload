...
The latest, recommended version of LazyLoad is **17.8.0**.
...
```html
<script src="https://cdn.jsdelivr.net/npm/vanilla-lazyload@17.8.0/dist/lazyload.min.js"></script>
```
...
<script
  async
  src="https://cdn.jsdelivr.net/npm/vanilla-lazyload@17.8.0/dist/lazyload.min.js"
></script>
```
