...
| `threshold`         | The outer distance from of the scrolling area, expressed in pixels, from which to start loading the elements                                                                                                                                                                                                                                                                                                                         | `300`         |
| `rootMargin`        | A string with syntax similar to the CSS margin property, which allows you to adjust the bounds of the scrolling area outwards, so that the elements to be loaded are shown before they phisically enter the scrolling area. [More info](https://developer.mozilla.org/en-US/docs/Web/API/IntersectionObserver/rootMargin). It overrides `threshold` when passed. Available only in version 10.x, gracefully degrades on version 8.x. | `null`        |
