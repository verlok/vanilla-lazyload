...
| --------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------- | -------------------------------------------------------------------------------------- |
| Content   | Simple lazy loaded image. Uses an inline SVG as a placeholder.                                 | [Code](demos/image_simple.html)                | [Live](https://www.andreaverlicchi.eu/lazyload/demos/image_simple.html)                |
| Content   | Simple lazy loaded image. Uses an external SVG file as a placeholder.                          | [Code](demos/image_simple.html)                | [Live](https://www.andreaverlicchi.eu/lazyload/demos/image_simple_external_ph.html)    |
