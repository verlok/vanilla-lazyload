LazyLoad is a fast, lightweight and flexible script that _speeds up your web application_ by **loading your content images, videos and iframes only as they enter the viewport**. It's written in plain "vanilla" JavaScript, it leverages the [IntersectionObserver](https://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API) API, and it works with [responsive images](https://alistapart.com/article/responsive-images-in-practice). It's also SEO-friendly, allows you to use **native lazy loading** where supported, and it has some other [notable features](#-notable-features).
